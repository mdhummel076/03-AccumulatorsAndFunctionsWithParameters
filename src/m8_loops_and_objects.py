...
def draw_circles1():
    ...
    for n in range(0,210,10):
        rg.Circle(rg.Point(200,200),n).attach_to(window)
    window.render()
...
def draw_circles2():
    ...
    window = rg.RoseWindow(400, 400)
    for n in range(50, 400, 10):
        circle = rg.Circle(rg.Point(n, 100), 10)
...
def draw_circles3():
    ...
    for n in range(1, 101, 1):
        rg.Circle(rg.Point(200, 150), n).attach_to(window)
    window.render()
    window.close_on_mouse_click()
...
def draw_cosines_and_sines():
    ...
    window = rg.RoseWindow(400, 400)
    for n in range(101):
        rg.Circle(rg.Point(200+(80*math.cos(n)), 200+(80*math.sin(n))), 10).attach_to(window)
    window.render()
    window.close_on_mouse_click()
